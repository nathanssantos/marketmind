...
import { drawCandle, drawRect, drawLine, drawText, clearCanvas } from '../../utils/canvas/drawingUtils';
import { priceToY, yToPrice, calculateBounds } from '../../utils/canvas/coordinateSystem';
