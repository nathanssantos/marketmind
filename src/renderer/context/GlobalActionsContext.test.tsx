...
describe('GlobalActionsContext', () => {
  const TestComponent = () => {
    ...
    return (
      <div>
        ...
        <button onClick={actions.toggleChatSidebar}>Toggle Chat</button>
        <button onClick={actions.focusChatInput}>Focus Chat</button>
  ...
  it('should provide actions to children', () => {
    ...
    expect(screen.getByText('Toggle Chat')).toBeTruthy();
    expect(screen.getByText('Focus Chat')).toBeTruthy();
  ...
  it('should call actions when buttons are clicked', () => {
    ...
    screen.getByText('Toggle Chat').click();
    expect(mockActions.toggleChatSidebar).toHaveBeenCalled();

    screen.getByText('Focus Chat').click();
    expect(mockActions.focusChatInput).toHaveBeenCalled();
