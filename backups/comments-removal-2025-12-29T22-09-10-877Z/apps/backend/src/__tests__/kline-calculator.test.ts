...
describe('kline-calculator', () => {
  describe('constants', () => {
    it('should have correct constant values', () => {
      expect(MIN_KLINES).toBe(100);
      expect(MAX_KLINES).toBe(500);
      expect(DEFAULT_KLINES).toBe(300);
    });
  });
