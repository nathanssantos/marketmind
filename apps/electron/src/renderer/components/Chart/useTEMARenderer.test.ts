...
describe('useTEMARenderer', () => {
  ...
  describe('render', () => {
    ...
    it('should not render when temaData is null', () => {
      const { result } = renderHook(() =>
        useTEMARenderer({
          manager: mockManager,
          temaData: null,
    ...
    it('should render TEMA when enabled with valid data', () => {
      const { result } = renderHook(() =>
        useTEMARenderer({
          manager: mockManager,
          temaData: mockTemaData,
