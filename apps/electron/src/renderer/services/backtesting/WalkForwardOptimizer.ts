...
export class WalkForwardOptimizer {
  ...
  static async optimizeWindow(
    ...
    for (const params of parameterCombinations) {
      ...
      const result = await BacktestOrchestrator.runBacktest(
        window.trainingKlines,
  ...
  static async testWindow(
    ...
    return BacktestOrchestrator.runBacktest(window.testingKlines, config.initialCapital, config);
  }
