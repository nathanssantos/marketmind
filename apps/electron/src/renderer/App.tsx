...
function ToastRenderer({ toast }: ToastRendererProps): ReactElement {
  const { t } = useTranslation();
  const symbol = toast.meta?.['symbol'] as string | undefined;
  const marketType = toast.meta?.['marketType'] as MarketType | undefined;
    ...
    <ErrorBoundary>
      <PreferencesHydrator>
        <Toaster toaster={toaster}>
          {(toast) => <ToastRenderer toast={toast as ToastRendererProps['toast']} />}
        </Toaster>
        <ChartProvider>
