export const MIN_KLINES_FOR_ML = 100;
export const MAX_KLINES_FOR_ML = 500;
export const DEFAULT_KLINES_FOR_ML = 300;
...
export const calculateRequiredKlinesForML = (strategies: StrategyDefinition[]): number => {
  let maxPeriod = 50;
  ...
  return Math.min(Math.max(requiredKlines, MIN_KLINES_FOR_ML), MAX_KLINES_FOR_ML);
};
