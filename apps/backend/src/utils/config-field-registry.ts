...
const TRADING_PROFILE_FIELDS: ConfigFieldDef[] = [
  ...
  { key: 'tradingMode' },
  { key: 'directionMode' },
  { key: 'positionSizePercent', transform: (v) => v != null ? String(v) : null },
  { key: 'useTrendFilter' },
  { key: 'useAdxFilter' },
  { key: 'useChoppinessFilter' },
  { key: 'useVwapFilter' },
  ...
  { key: 'fibonacciTargetLevelShort' },
  { key: 'fibonacciSwingRange' },
  { key: 'maxFibonacciEntryProgressPercentLong', transform: (v) => v != null ? String(v) : null },
  { key: 'maxFibonacciEntryProgressPercentShort', transform: (v) => v != null ? String(v) : null },
  { key: 'initialStopMode' },
  { key: 'tpCalculationMode' },
  { key: 'minRiskRewardRatioLong', transform: (v) => v != null ? String(v) : null },
  { key: 'minRiskRewardRatioShort', transform: (v) => v != null ? String(v) : null },
  { key: 'trailingStopEnabled' },
  { key: 'trailingStopMode' },
  { key: 'trailingActivationPercentLong', transform: (v) => v != null ? String(v) : null },
  { key: 'trailingActivationPercentShort', transform: (v) => v != null ? String(v) : null },
  { key: 'trailingDistancePercentLong', transform: (v) => v != null ? String(v) : null },
  { key: 'trailingDistancePercentShort', transform: (v) => v != null ? String(v) : null },
  { key: 'trailingDistanceMode' },
  { key: 'trailingStopOffsetPercent', transform: (v) => v != null ? String(v) : null },
  { key: 'trailingActivationModeLong' },
  { key: 'trailingActivationModeShort' },
  { key: 'useAdaptiveTrailing' },
  { key: 'maxDrawdownEnabled' },
  { key: 'maxDrawdownPercent', transform: (v) => v != null ? String(v) : null },
  { key: 'dailyLossLimit', transform: (v) => v != null ? String(v) : null },
  { key: 'maxRiskPerStopEnabled' },
  { key: 'maxRiskPerStopPercent', transform: (v) => v != null ? String(v) : null },
  { key: 'choppinessThresholdHigh', transform: (v) => v != null ? String(v) : null },
  { key: 'choppinessThresholdLow', transform: (v) => v != null ? String(v) : null },
  { key: 'volumeFilterObvLookbackLong' },
  { key: 'volumeFilterObvLookbackShort' },
  { key: 'useObvCheckLong' },
  { key: 'useObvCheckShort' },
