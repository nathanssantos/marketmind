...
import { createTestTradingProfile, createTestUser, createTestWallet, DEFAULT_PYRAMID_CONFIG, DEFAULT_TRAILING_STOP_USER_CONFIG } from '../helpers/test-fixtures';
  ...
  describe('AutoTradingService', () => {
    it('should calculate position size correctly with fixed sizing', async () => {
      ...
      const config = {
        ...
        minRiskRewardRatioLong: '1.00',
        minRiskRewardRatioShort: '1.00',
