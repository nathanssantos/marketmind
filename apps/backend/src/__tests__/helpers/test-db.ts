...
CREATE TABLE IF NOT EXISTS auto_trading_config (
  ...
  use_direction_filter BOOLEAN DEFAULT true NOT NULL,
  ...
  min_risk_reward_ratio_short NUMERIC(4, 2) DEFAULT '0.80',
  ...
  trailing_activation_percent_long NUMERIC(5, 3) DEFAULT '1.0' NOT NULL,
  trailing_activation_percent_short NUMERIC(5, 3) DEFAULT '0.886' NOT NULL,
  trailing_distance_percent NUMERIC(5, 3) DEFAULT '0.4' NOT NULL,
