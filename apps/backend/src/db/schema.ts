...
export const autoTradingConfig = pgTable('auto_trading_config', {
  ...
  useMtfFilter: boolean('use_mtf_filter').default(true).notNull(),
  useBtcCorrelationFilter: boolean('use_btc_correlation_filter').default(true).notNull(),
  useMarketRegimeFilter: boolean('use_market_regime_filter').default(true).notNull(),
  ...
  fibonacciTargetLevelShort: varchar('fibonacci_target_level_short', { length: 10 }).$type<'auto' | '1' | '1.272' | '1.618' | '2' | '2.618'>().default('1.272'),
