...
export const autoTradingConfig = pgTable('auto_trading_config', {
  ...
  useVolumeFilter: boolean('use_volume_filter').default(true).notNull(),
  ...
  fibonacciTargetLevelLong: varchar('fibonacci_target_level_long', { length: 10 }).$type<'auto' | '1' | '1.272' | '1.382' | '1.618' | '2' | '2.618' | '3' | '3.618' | '4.236'>().default('2').notNull(),
  ...
  trailingActivationPercentShort: numeric('trailing_activation_percent_short', { precision: 5, scale: 4 }).default('0.8').notNull(),
