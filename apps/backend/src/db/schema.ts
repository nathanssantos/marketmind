...
export const autoTradingConfig = pgTable('auto_trading_config', {
  ...
  minRiskRewardRatioLong: numeric('min_risk_reward_ratio_long', { precision: 4, scale: 2 }).default('0.50'),
  ...
  fibonacciTargetLevel: varchar('fibonacci_target_level', { length: 10 }).$type<'auto' | '1' | '1.272' | '1.382' | '1.618' | '2' | '2.618' | '3' | '3.618' | '4.236'>().default('3.618').notNull(),
  fibonacciTargetLevelLong: varchar('fibonacci_target_level_long', { length: 10 }).$type<'auto' | '1' | '1.272' | '1.382' | '1.618' | '2' | '2.618' | '3' | '3.618' | '4.236'>().default('3.618').notNull(),
  ...
  trailingActivationPercentLong: numeric('trailing_activation_percent_long', { precision: 5, scale: 4 }).default('1.272').notNull(),
