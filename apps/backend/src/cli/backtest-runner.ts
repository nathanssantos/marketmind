...
program
  ...
  .option('--min-confidence <level>', 'Minimum confidence level (0-100, default: strategy minConfidence)')
  .option('--max-position <percent>', 'Maximum position size as % of capital', '10')
  .option('--position-method <method>', 'Position sizing method: fixed-fractional, risk-based, kelly, volatility-based', 'fixed-fractional')
