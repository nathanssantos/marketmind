...
export { TIME_MS, INTERVAL_MS, INTERVAL_MINUTES };

export const CHART_INITIAL_KLINES = KLINE_CONFIG.CHART_INITIAL_LOAD;
export const CHART_PAGE_SIZE = KLINE_CONFIG.CHART_PAGE_SIZE;
export const AUTO_TRADING_KLINES = KLINE_CONFIG.AUTO_TRADING_LOOKBACK;
export const BACKFILL_TARGET_KLINES = KLINE_CONFIG.BACKFILL_TARGET;
export const MAINTENANCE_KLINES = KLINE_CONFIG.MAINTENANCE_LOOKBACK;
export const REQUIRED_KLINES = KLINE_CONFIG.CHART_INITIAL_LOAD;
...
export const BACKTEST_DEFAULTS = {
  POSITION_SIZE_PERCENT: TRADING_DEFAULTS.POSITION_SIZE_PERCENT,
  MIN_RISK_REWARD_RATIO: TRADING_DEFAULTS.MIN_RISK_REWARD_RATIO,
