...
export const INDICATOR_CATALOG: IndicatorMeta[] = [
  ...
  { id: 'STOCHASTIC_K', name: 'Stochastic %K', category: 'oscillator', defaultParams: { period: 14, smoothK: 3, smoothD: 3 }, paramLabels: { period: 'Period', smoothK: 'Smooth %K', smoothD: 'Smooth %D' }, valueRange: { min: 0, max: 100 }, requiresKlines: true },
  { id: 'STOCHASTIC_D', name: 'Stochastic %D', category: 'oscillator', defaultParams: { period: 14, smoothK: 3, smoothD: 3 }, paramLabels: { period: 'Period', smoothK: 'Smooth %K', smoothD: 'Smooth %D' }, valueRange: { min: 0, max: 100 }, requiresKlines: true },
