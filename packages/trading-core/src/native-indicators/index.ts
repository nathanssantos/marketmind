...
import type { IndicatorParamValue } from '../indicators/types';
...
export const NATIVE_SERIES_EVALUATORS: Record<string, NativeEvaluator> = {
  dema: (klines, params) => {
...
export const hasNativeSeriesEvaluator = (scriptId: string): boolean =>
  Object.prototype.hasOwnProperty.call(NATIVE_SERIES_EVALUATORS, scriptId);

export const getNativeSeriesEvaluator = (scriptId: string): NativeEvaluator | undefined =>
  NATIVE_SERIES_EVALUATORS[scriptId];
