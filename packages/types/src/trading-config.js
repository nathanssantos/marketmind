...
export const EXIT_CALCULATOR_CONFIG = {
    ...
    MAX_FIBONACCI_ENTRY_PROGRESS_PERCENT: 78.6,
};
...
export const STABLECOINS = ['USDT', 'USDC', 'BUSD', 'DAI', 'TUSD'];
...
export const ACTIVE_TRADE_STATUSES = [TRADE_STATUS.OPEN, TRADE_STATUS.PENDING];
