...
export const TRAILING_STOP_USER_DEFAULTS: TrailingStopUserConfig = {
  ...
  trailingDistancePercentLong: 0.6,
...
export const EXIT_CALCULATOR_CONFIG = {
  ...
  SWING_SKIP_RECENT: 3,
  NEAREST_SWING_LOOKBACK: 20,
  NEAREST_SWING_FRACTAL_BARS: 2,
...
export const SCALPING_DEFAULTS = {
  ...
  LARGE_TRADE_MULTIPLIER: 4.0,
  ABSORPTION_VOLUME_THRESHOLD: 3.0,
  MAX_SPREAD_PERCENT: 0.03,
  MICRO_TRAILING_TICKS: 8,
  POST_ONLY_MAX_RETRIES: 3,
  ORDER_REPLACE_THRESHOLD_TICKS: 2,
  DEPTH_LEVELS: 20,
  BOOK_SNAPSHOT_INTERVAL_MS: 60_000,
  METRICS_EMIT_INTERVAL_MS: 200,
  CIRCUIT_BREAKER_LOSS_PERCENT: 2.0,
  CIRCUIT_BREAKER_MAX_TRADES: 50,
  MAX_DAILY_TRADES: 50,
  MAX_DAILY_LOSS_PERCENT: 2.0,
  AGG_TRADE_BUFFER_SIZE: 100,
  AGG_TRADE_FLUSH_INTERVAL_MS: 1_000,
  AGG_TRADE_RETENTION_DAYS: 30,
  MAX_CONSECUTIVE_LOSSES: 3,
  CONSECUTIVE_LOSS_COOLDOWN_MS: 15 * 60 * 1_000,
} as const;
...
export const KLINE_CONFIG = {
  ABSOLUTE_MINIMUM: 2_000,
  CHART_INITIAL_LOAD: 10_000,
  CHART_PAGE_SIZE: 5_000,
  AUTO_TRADING_LOOKBACK: 2_000,
  BACKFILL_TARGET: 20_000,
  MAINTENANCE_LOOKBACK: 10_000,
  COOLDOWN_GAP_CHECK_MS: 2 * TIME_MS.HOUR,
  COOLDOWN_CORRUPTION_CHECK_MS: 2 * TIME_MS.HOUR,
